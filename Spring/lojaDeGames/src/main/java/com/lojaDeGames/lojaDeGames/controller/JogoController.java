...
public class JogoController {
	...
	@Autowired
	private JogoRepository repositoty;
	...
	public ResponseEntity<Jogo> post(@RequestBody Jogo jogo){
		return ResponseEntity.status(HttpStatus.CREATED).body(repositoty.save(jogo));
	}
	
	@PutMapping 
	public ResponseEntity<Jogo> put(@RequestBody Jogo jogo){
		return ResponseEntity.status(HttpStatus.OK).body(repositoty.save(jogo));
	}
